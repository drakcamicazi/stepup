    ...
    var s = function (t) {
        ...
        24: function (t, e) {
            t.exports = function (t) {
                ...
                var s = e.protocol + "//" + e.host, i = s + e.pathname.replace(/\/[^\/]*$/, "/"),
                    n = t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (t, e) {
            ...
            function u(t, e) {
                for (var s = 0; s < t.length; s++) {
                    ...
                    if (n) {
                        ...
                        for (; r < i.parts.length; r++) n.parts.push(b(i.parts[r], e))
                    } else {
                        for (var o = [], r = 0; r < i.parts.length; r++) o.push(b(i.parts[r], e));
            ...
            function g(t, e) {
                for (var s = [], i = {}, n = 0; n < t.length; n++) {
                    var a = t[n], r = e.base ? a[0] + e.base : a[0], o = a[1], l = a[2], d = a[3],
                        h = {css: o, media: l, sourceMap: d};
                    i[r] ? i[r].parts.push(h) : s.push(i[r] = {id: r, parts: [h]})
                }
                return s
            }

            function v(t, e) {
                var s = o(t.insertInto);
                ...
                var i = h[h.length - 1];
                if ("top" === t.insertAt) i ? i.nextSibling ? s.insertBefore(e, i.nextSibling) : s.appendChild(e) : s.insertBefore(e, s.firstChild), h.push(e); else if ("bottom" === t.insertAt) s.appendChild(e); else {
            ...
            function m(t) {
                ...
                return t.attrs.type = "text/css", p(e, t.attrs), v(t, e), e
            }
            ...
            function b(t, e) {
                ...
                if (e.singleton) {
                    var r = d++;
                    s = l || (l = m(e)), i = k.bind(null, s, r, !1), n = k.bind(null, s, r, !0)
                    ...
                    return t.attrs.type = "text/css", t.attrs.rel = "stylesheet", p(e, t.attrs), v(t, e), e
                }(e), i = function (t, e, s) {
                    var i = s.css, n = s.sourceMap, a = void 0 === e.convertToAbsoluteUrls && n;
                ...
                }) : (s = m(e), i = function (t, e) {
                    var s = e.css, i = e.media;
                    if (i && t.setAttribute("media", i), t.styleSheet) t.styleSheet.cssText = s; else {
            ...
            function k(t, e, s, i) {
                var n = s ? "" : i.css;
                if (t.styleSheet) t.styleSheet.cssText = x(e, n); else {
                    var a = document.createTextNode(n), r = t.childNodes;
            ...
            var n = {hmr: !1, transform: void 0, insertInto: void 0};
            s(25)(i, n), i.locals && (t.exports = i.locals)
        }, 449: function (t, e, s) {
            "use strict";
            Object.defineProperty(e, "__esModule", {value: !0}), e.ThemeSettings = void 0;
            var i = function () {
                function t(t, e) {
            ...
            }(), n = s(448), a = (c(n), s(446)), r = c(a), o = s(445), l = c(o), d = s(444), h = c(d);
            ...
            var u = [{
                    ...
                    name: "theme-gradient",
                    title: "Gradient",
                    colors: {primary: "#775cdc", navbar: "#ffffff", sidenav: "linear-gradient(to top, #4e54c8, #8c55e4)"}
                }, {
                    name: "theme-paper",
                    title: "Paper",
                ...
                f = ["rtl", "material", "layoutPosition", "layoutNavbarFixed", "layoutFooterFixed", "layoutReversed", "navbarBg", "sidenavBg", "footerBg", "themes"],
                m = ["navbar-theme", "primary", "primary-dark navbar-dark", "primary-darker navbar-dark", "secondary", "secondary-dark navbar-dark", "secondary-darker navbar-dark", "success", "success-dark navbar-dark", "success-darker navbar-dark", "info", "info-dark navbar-dark", "info-darker navbar-dark", "warning", "warning-dark navbar-light", "warning-darker navbar-light", "danger", "danger-dark navbar-dark", "danger-darker navbar-dark", "dark", "white", "light", "lighter"],
                p = "navbar-theme",
                b = ["sidenav-theme", "primary", "primary-dark sidenav-dark", "primary-darker sidenav-dark", "secondary", "secondary-dark sidenav-dark", "secondary-darker sidenav-dark", "success", "success-dark sidenav-dark", "success-darker sidenav-dark", "info", "info-dark sidenav-dark", "info-darker sidenav-dark", "warning", "warning-dark sidenav-light", "warning-darker sidenav-light", "danger", "danger-dark sidenav-dark", "danger-darker sidenav-dark", "dark", "white", "light", "lighter"],
                y = "sidenav-theme",
                x = ["footer-theme", "primary", "primary-dark footer-dark", "primary-darker footer-dark", "secondary", "secondary-dark footer-dark", "secondary-darker footer-dark", "success", "success-dark footer-dark", "success-darker footer-dark", "info", "info-dark footer-dark", "info-darker footer-dark", "warning", "warning-dark footer-light", "warning-darker footer-light", "danger", "danger-dark footer-dark", "danger-darker footer-dark", "dark", "white", "light", "lighter"],
                k = "footer-theme", _ = function () {
                    function t(e) {
                        var s = e.cssPath, i = e.themesPath, n = e.cssFilenamePattern, a = e.controls, r = e.sidenavBgs,
                            o = e.defaultSidenavBg, l = e.navbarBgs, d = e.defaultNavbarBg, h = e.footerBgs,
                            c = e.defaultFooterBg, _ = e.availableThemes, w = e.defaultTheme, S = e.pathResolver;
                        if (e.onSettingsChange, function (t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), !this._ssr) {
                            if (!window.layoutHelpers) throw new Error("window.layoutHelpers required.");
                            this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = n || v, this.settings.navbarBgs = l || m, this.settings.defaultNavbarBg = d || p, this.settings.sidenavBgs = r || b, this.settings.defaultSidenavBg = o || y, this.settings.footerBgs = h || x, this.settings.defaultFooterBg = c || k, this.settings.availableThemes = _ || u, this.settings.defaultTheme = this.settings.availableThemes[void 0 !== w ? w : g], this.settings.controls = a || f, this.pathResolver = S || function (t) {
                                return t
                    ...
                    return i(t, [{
                        ...
                        key: "setMaterial", value: function (t) {
                        ...
                        key: "setTheme", value: function (t) {
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                if (r) {
                                    ...
                                    }), n && this.settings.onSettingsChange(this.settings)
                                }
                            }
                        }
                    }, {
                        key: "setLayoutPosition", value: function (t) {
                        ...
                        key: "setLayoutNavbarFixed", value: function (t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                        ...
                        key: "setLayoutReversed", value: function (t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                        ...
                        key: "setNavbarBg", value: function (t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                        ...
                        key: "setSidenavBg", value: function (t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : document;
                        ...
                        key: "setFooterBg", value: function (t) {
                            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : document;
                        ...
                        key: "updateNavbarBg", value: function () {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document;
                            this.setNavbarBg(this.settings.navbarBg, !1, t)
                        }
                    }, {
                        key: "updateSidenavBg", value: function () {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document;
                            this.setSidenavBg(this.settings.sidenavBg, !1, t)
                        }
                    }, {
                        key: "updateFooterBg", value: function () {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document;
                        ...
                        key: "_setup", value: function () {
                            ...
                            var n = this.container.querySelector(".theme-settings-close-btn"), a = function () {
                            ...
                            n.addEventListener("click", a), this._listeners.push([n, "click", a]);
                            var o = this.container.querySelector(".theme-settings-rtl");
                            if (this._hasControls("rtl")) {
                                ...
                                d.addEventListener("change", c), this._listeners.push([d, "change", c])
                            ...
                            this._hasControls("navbarBg") ? (this._controls.navbarBgWInner = k.querySelector(".theme-settings-navbarBg-inner"), this.settings.navbarBgs.forEach(function (e) {
                                var s = t._getElementFromString(h.default), i = s.querySelector("input");
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                this.settings.availableThemes.forEach(function (e) {
                                    var s = t._getElementFromString(l.default), i = s.querySelector("input");
                        ...
                        key: "_waitForNavs", value: function () {
                            var t = this;
                        ...
                        key: "_addObserver", value: function (t, e, s) {
                            var i = this;
                            ...
                            document.querySelector(t) ? s.call(this) : document.body || ("undefined" != typeof MutationObserver ? (n = new MutationObserver(function (t) {
                                t.forEach(function (t) {
                                    if (t.addedNodes) for (var a = 0; a < t.addedNodes.length; a++) {
                        ...
                        key: "_clearObservers", value: function () {
                            if (this._observers && this._observers.length) for (var t = 0, e = this._observers.length; t < e; t++) this._observers[t].disconnect();
                            if (this._intervals && this._intervals.length) for (var s = 0, i = this._intervals.length; s < i; s++) clearInterval(this._intervals[s]);
                        ...
                        key: "_getThemeByFile", value: function (t) {
